...
% Resources (demand)
  ...
  \node[state] (MP) [right of=cook, node distance=4.8cm] {MP};
  \node[state] (H) [right of=heat, node distance=4.8cm] {H};
  \node[state] (L) [right of=apps, node distance=4.8cm] {L};
% Dummy nodes to draw demand arrows
  \node[] (Wtr-D) [right of=Wtr] {};
  \node[] (F-D) [right of=F] {};
  \node[] (MP-D) [right of=MP] {};
  \node[] (H-D) [right of=H] {};
  \node[] (L-D) [right of=L] {};
